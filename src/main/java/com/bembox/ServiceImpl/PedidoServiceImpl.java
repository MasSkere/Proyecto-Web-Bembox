...
public class PedidoServiceImpl implements PedidoService {
    ...
    public List<Pedido> obtenerUltimosPedidos(int cantidad) {
        // Si quisieras parametrizar la cantidad, puedes usar un Pageable;
        // aquí usamos siempre 5 para simplificar
